/**
 * This page implements Ajax functions and Jquery functions for creating and managin test queues on main.php
 */

var isAdmin;
var userid;

// Create UI table with test details of tests which are in currently running state
...
// Ajax call for getting list of currently running test on server
...
// Create UI table with test details of tests which are in waiting queue of scheduler
...
// Ajax call for getting list of currently waiting test in scheduler queue
...
// Display different colored circle to denote test state in completed test queue
...
// Create UI table with test details of tests which are completed recently
...
// Ajax call for getting list of recently completed test by scheduler
...
// Query test list for all three queues i.e. Currently running, waiting queue and last completed
