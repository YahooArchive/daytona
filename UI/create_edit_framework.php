<?php
/**
 * This is create/edit framework page, user can add new framework definition or edit an existing framework definition.
 * User need to provide execution script location on execution host and script arguments. User can also customize test
 * report page which is framework specific. User can also clone existing framework and save it as new framework.
 *
 * Refer create_edit_framework.js file for all Jquery functions.
 */
...
if (!preg_match('/^(create|clone|edit)$/', $action)) {
    diePrint("Unknown action: $action", "Error");
}

if ($action == 'clone' || $action == 'edit') {
    if (!$frameworkData) {
        diePrint("No framework name or framework ID passed in", "Error");
    }
    if ($action == 'clone') {
        $frameworkId = null;
        $frameworkName = null;
        ...
        <form id="framework-form">
                                ...
                                <tr>
                                    ...
                                    <td class="zero-line-height tiny-padding">
                                        <div class="form-group zero-line-height zero-margin">
                                            <input type="text" class="form-control form-input" name="f_frameworkname"
                                                   id="f_frameworkname"
                                                   value="<?php echo ($action == 'edit' && $frameworkData) ? $frameworkData['frameworkname'] : null; ?>"
                                                   required <?php echo ($action == 'edit' && $frameworkData) ? 'readonly' : null; ?>>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="zero-line-height tiny-padding">
                                        <div class="form-group zero-line-height zero-margin">
                                            <input type="text" class="form-control form-input" name="f_productname"
                                                   id="f_productname"
                                                   value="<?php echo $frameworkData ? $frameworkData['productname'] : null; ?>"
                                                   required>
                                        </div>
                                    </td>
                                </tr>
                                    ...
                                    <td class="zero-line-height tiny-padding">
                                        <div class="form-group zero-line-height zero-margin">
                                            <input type="text" class="form-control form-input" name="f_title"
                                                   id="f_title"
                                                   value="<?php echo $frameworkData ? $frameworkData['title'] : null; ?>">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="zero-line-height tiny-padding">
                                        <div class="form-group zero-line-height zero-margin">
                                            <input type="text" class="form-control form-input" name="f_frameworkowner"
                                                   id="f_frameworkowner" value="<?php if ($action == 'clone') {
                                                echo $userId;
                                            } else {
                                                echo $frameworkData ? $frameworkData['frameworkowner'] : $userId;
                                            } ?>" required pattern="^[a-zA-Z][a-zA-Z0-9_]*$" readonly>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="zero-line-height tiny-padding">
                                        <div class="form-group zero-line-height zero-margin">
                                            <input type="text" class="form-control form-input" name="f_execution_host"
                                                   id="f_execution_host"
                                                   value="<?php echo ($frameworkData && $frameworkData['execution_host']) ? $frameworkData['execution_host']['default_value'] : null ?>">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="zero-line-height tiny-padding">
                                        <div class="form-group zero-line-height zero-margin">
                                            <input type="text" class="form-control form-input" name="f_statistics_host"
                                                   id="f_statistics_host"
                                                   value="<?php echo ($frameworkData && $frameworkData['statistics_host']) ? $frameworkData['statistics_host']['default_value'] : null ?>">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="zero-line-height tiny-padding">
                                        <div class="form-group zero-line-height zero-margin">
                                            <textarea class="form-control purpose-textarea" rows="4" name="f_purpose"
                                                      id="f_purpose"><?php echo $frameworkData ? $frameworkData['purpose'] : null; ?></textarea>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="zero-line-height tiny-padding">
                                        <div class="form-group zero-line-height zero-margin">
                                            <input type="number" class="form-control form-input"
                                                   name="f_default_timeout" id="f_default_timeout" min="0"
                                                   value="<?php echo $frameworkData ? $frameworkData['default_timeout'] : 0 ?>">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="active success" style="vertical-align: middle">
                                        <a href='#' data-toggle='tooltip'
                                           title="Execution script should be in <daytona_install_dir>/ExecScripts/<folder>/ path on exec host. Enter <folder>/<execution_script>">Execution
                                            Script</a>
                                    </td>
                                    <td class="zero-line-height tiny-padding">
                                        <div class="form-group zero-line-height zero-margin">
                                            <input type="text" class="form-control form-input"
                                                   name="f_execution_script_location" id="f_execution_script_location"
                                                   value="<?php echo $frameworkData ? $frameworkData['execution_script_location'] : null; ?>"
                                                   required>
                                        </div>
                                    </td>
                                </tr>
                        ...
                        <div style="padding-left:5px;">
                            <div class="form-select shift-popover">
                                ...
                                <select class="select-sm" name="f_argument_passing_format">
                                    <option value="arg_order" <?php echo ($frameworkData && $frameworkData['argument_passing_format'] == 'arg_order') ? 'selected' : null ?>>
                                        Use argument order
                                    </option>
                                    <option value="name_order" <?php echo ($frameworkData && $frameworkData['argument_passing_format'] == 'name_order') ? 'selected' : null ?>>
                                        Use named arguments
                                    </option>
                                </select></div>
                            <div class="add-item" id="add_args_item">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="main-panel-alt-bottom">
                ...
                <div id="action-buttons-div" class="col-md-6">
                    ...
                    <a href="/<?php echo $frameworkId ? "?frameworkid=$frameworkId" : "" ?>" type="button"
