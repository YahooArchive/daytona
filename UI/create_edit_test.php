            ...
            <div id="main-panel-alt">
                <div class="zero-margin zero-padding">
					...
					<a href="#" data-toggle="tooltip" title="Work in progress">
                                    ...
                                    <td class='zero-line-height tiny-padding'>
                                        <select class='form-control float-left' name='f_priority' id='f_priority' disabled>
                                            <?php
                                            for ($x = 1; $x <=5; $x++) {
				...
				<tr>
                                    ...
                                    <td class='zero-line-height tiny-padding'>
                                        <div class='form-group zero-line-height zero-margin'>
                                            <input type="number" min="0" class='form-control form-input' name='f_timeout' id='f_timeout' value="<?php echo $testData ? $testData['timeout'] : $frameworkData['default_timeout']; ?>" required>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td class='active' style='vertical-align: middle'>
                                        <a href="#" data-toggle="tooltip" title="Enter comma seperated email address list for sending test completion report">
                                        Email List
                                    </td>
                                    <td class='zero-line-height tiny-padding'>
                                        <div class='form-group zero-line-height zero-margin'>
                    ...
                    <div class="panel panel-info panel-sub-main">
                        ...
                        <div class="panel-body" id='zero-padding'>
                            <div class="checkbox padding-left">
                                <label>
                                    <input type="checkbox" name="f_strace" id="f_strace" <?php if ($strace) echo "checked"; ?>> Enable STRACE
                                </label>
                            </div>
                            <table class='table table-hover form-table' <?php if (!$strace) echo "style=\"display: none\""?> id="strace_config">
                                <tbody>
                                <tr>
                                    <td class='active success' style='width: 30%; vertical-align: middle'>
                                    ...
                                    <td class='zero-line-height tiny-padding'>
                                        <div class='form-group zero-line-height zero-margin'>
                                            <input type='number' class='form-control form-input' min="10" <?php if (!$strace) echo "disabled=\"disabled\""?> name='f_strace_delay' id='f_strace_delay' value="<?php if (isset($testData)) { echo array_key_exists('strace_delay',$testData) ? $testData['strace_delay'] : 10; } else { echo 10; } ?>" required>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class='zero-line-height tiny-padding'>
                                        <div class='form-group zero-line-height zero-margin'>
                                            <input type='number' class='form-control form-input' min="10" max="30" <?php if (!$strace) echo "disabled=\"disabled\""?> name='f_strace_duration' id='f_strace_duration' value="<?php if (isset($testData)) { echo array_key_exists('strace_duration',$testData) ? $testData['strace_duration'] : 10; } else { echo 10;} ?>" required>
                                        </div>
                                    </td>
                                </tr>
				<tr>
                        ...
                        <div class="panel panel-info panel-sub-main">
                            ...
                            <div class="panel-body" id='zero-padding'>
                                <div class="checkbox padding-left">
                                    <label>
                                        <input type="checkbox" name="f_perf" id="f_perf" <?php if ($perf_process) echo "checked"; ?>> Enable process level PERF
                                    </label>
                                </div>
                                <table class='table table-hover form-table' id="perf_config">
                                    ...
                                    <tr>
                                        ...
                                        <td class='zero-line-height tiny-padding'>
                                            <div class='form-group zero-line-height zero-margin'>
                                                <input type='number' class='form-control form-input' min="10" name='f_perf_delay' id='f_perf_delay' value="<?php if (isset($testData)) { echo array_key_exists('perf_delay',$testData) ? $testData['perf_delay'] : 10; } else {echo 10;} ?>" required>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class='zero-line-height tiny-padding'>
                                            <div class='form-group zero-line-height zero-margin'>
                                                <input type='number' class='form-control form-input' min="10" max="30" name='f_perf_duration' id='f_perf_duration' value="<?php if (isset($testData)) { echo array_key_exists('perf_duration',$testData) ? $testData['perf_duration'] : 10; } else {echo 10;} ?>" required>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr <?php if (!$perf_process) echo "style=\"display: none\""?> id="perf_process_config">
                                        <td class='active success' style='width: 30%; vertical-align: middle'>
                                            Process Name
                                        </td>
                                        <td class='zero-line-height tiny-padding'>
                                            <div class='form-group zero-line-height zero-margin'>
                                                <input type='text' class='form-control form-input' <?php if (!$perf_process) echo "disabled=\"disabled\""?> name='f_perf_process' id='f_perf_process' value="<?php if (isset($testData)) echo array_key_exists('perf_process',$testData) ? $testData['perf_process'] : null; ?>" required>
                                            </div>
                                        </td>
                                    </tr>
                                    </tbody>
